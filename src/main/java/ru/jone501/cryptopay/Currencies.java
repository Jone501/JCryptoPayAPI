...
import ru.jone501.cryptopay.types.CurrencyList;
...
public class Currencies {
    ...
    public static CurrencyList stablecoins() {
        return currencies.byType(Currency.CurrencyType.STABLECOIN);
    }

    public static CurrencyList blockchain() {
        return currencies.byType(Currency.CurrencyType.BLOCKCHAIN);
    }

    public static CurrencyList crypto() {
        return currencies.byType(Currency.CurrencyType.BLOCKCHAIN, Currency.CurrencyType.STABLECOIN);
    }

    public static CurrencyList fiat() {
        return currencies.byType(Currency.CurrencyType.FIAT);
    }
